...
def set_output_folders(model_name, OUTPUT_PARAMS):
    res_dir = os.path.join(OUTPUT_PARAMS['RESULT_PATH'], OUTPUT_PARAMS['PROJECT_NAME'] + '_' + model_name)
    models_dir = os.path.join(OUTPUT_PARAMS['MODEL_PATH'], OUTPUT_PARAMS['PROJECT_NAME'] + '_' + model_name)
